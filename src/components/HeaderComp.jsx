...
export default function HeaderComp() {
  ...
  const handleCurrencyChange = (e) => {
    ...
    // Option 1: Reload the page to force all components to re-read the currency.
    //window.location.reload();
    //Option 2: Dispatch an event so that components listening to currency changes update themselves.
